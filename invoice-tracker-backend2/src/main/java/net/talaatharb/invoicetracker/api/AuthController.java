...
//    signup controller incase we needed it.
    ...
    @GetMapping("/dayoffrequests")
	public ResponseEntity<ArrayList<User>> getUsers() {
		return ResponseEntity.ok().body(detailsServiceImpl.get_EmployeesRequests());
	}

	@PutMapping("/updateleaverequest/{request_id}")
	public ResponseEntity<Requests> UpdateEmployeeRequest(@RequestBody Requests req, @RequestParam int request_id) {

		return new ResponseEntity<>(detailsServiceImpl.update_a_leave_request(request_id, req), HttpStatus.OK);
