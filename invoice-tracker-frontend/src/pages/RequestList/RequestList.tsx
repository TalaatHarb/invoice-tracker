      ...
      <div className="flex flex-col min-h-screen bg-lightGrey bg-opacity-20 items-center">
        ...
        <div className="flex flex-row justify-start w-full">
          ...
          <div className="mx-11 my-12">
            <label className=" mr-1 h-60">
              <input className="mr-1  h-50" id="billable" type="checkbox" />
              Billable
            </label>
          </div>
          <div className="flex flex-row justify-end mt-28">
            <button className="ml-60 text-base rounded-md px-2 max-h-7 bg-yeollowLightCegedim text-black">
              Apply
            </button>
            <button className="mx-6 text-base rounded-md px-2 max-h-7  bg-yeollowLightCegedim text-black">
              Clear
            </button>
          </div>
        </div>
