...
const EmployeeDetails = ({ id }: employeeDetailsProps) => {
  ...
  const editClickHandler = async (event: any) => {
    ...
    if (id == "cancelEmployee") {
      setEditEmployee(employee);
      setEdit(false);
    } else if (id == "saveEmployee") {
      await axios
        .put(
          updateEmployeeUrl,
          {},
  ...
  return (
    <div className="ml-20 flex flex-row justify-between py-20 text-center">
      ...
      <div className="flex flex-col ml-20 text-lg w-3/6 " id="employeeDetails">
        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col justify-center ml-10 w-full whitespace-nowrap">
            {edit ? (
              ...
              <p className="mb-5 bg-white shadow-lg px-5 py-2" id="name">
            ...
            {edit ? (
              ...
              <p className=" bg-white shadow-lg px-5 py-2" id="jobTitle">
                {employee.jobTitle}
              </p>
            )}
          </div>
        ...
        {/* div for email */}
        <div className="flex flex-row ml-1 mt-6 items-center">
          <label className="whitespace-nowrap drop-shadow-md" id="emailLabel">
            Email:{" "}
          </label>
          {edit ? (
            <input
            ...
            <p className="bg-white shadow-lg ml-28 px-5 py-2 w-full" id="email">
              {employee.email}
            </p>
          )}
        </div>
        ...
        <div className="flex flex-row ml-1 mt-6 items-center">
          <button
            id={edit ? "saveEmployee" : "editEmployee"}
